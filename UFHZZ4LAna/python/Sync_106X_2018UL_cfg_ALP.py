...
myfilelist = cms.untracked.vstring(
        ...
        '/store/mc/RunIISummer20UL18MiniAODv2/HZaTo2l2g_M1_TuneCP5_PSWeights_13TeV-madgraph_pythia8/MINIAODSIM/106X_upgrade2018_realistic_v16_L1v1-v2/270000/0ADFB86E-F128-D144-B778-9955D736F946.root'
)
...
process.TFileService = cms.Service("TFileService",
                                  ...
                                  fileName = cms.string("Sync_106X_2018UL_"+date+"_"+str(run_events)+"ALP_V2.root")##
)
...
process.Ana = cms.EDAnalyzer('UFHZZ4LAna',
                              ...
                              photonSrc    = cms.untracked.InputTag("calibratedPatPhotons"),#bing
                              ...
                              skimLooseLeptons = cms.untracked.int32(1), #bing
                              skimTightLeptons = cms.untracked.int32(0), #bing        
...
process.p = cms.Path(process.fsrPhotonSequence*
                     ...
                     process.calibratedPatPhotons*#bing
